...
/*   Updated: 2022/02/02 19:24:33 by smagdela         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "parsing.h"

static int	categ_1(char *str, t_token *token_list, size_t *i)
{
...
static int	categ_2(char *str, t_token *token_list, size_t *i)
{
	char	*word_data;
...
static int	categ_3(char *str, t_token *token_list, size_t *i)
{
	char	*word_data;
...
static int	categ_4(char *str, t_token *token_list, size_t *i)
{
	char	*word_data;
